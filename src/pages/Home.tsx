  ...
  const features = [
    {
      ...
      description: 'Tailored solutions built with modern technologies for your unique business needs.'
    },
    {
      icon: Globe,
      title: 'Web Development',
      description: 'Responsive, scalable websites that engage users and drive business growth.'
    },
    {
      icon: Database,
      title: 'ERP Solutions',
      description: 'Integrated systems to streamline your business processes and boost productivity.'
    },
    {
      icon: Settings,
      title: 'IT Consultancy',
      description: 'Expert guidance in digital transformation and technology strategy.'
    },
    {
      icon: TrendingUp,
      title: 'Business Intelligence',
      description: 'Data-driven insights to make informed strategic business decisions.'
    },
    {
      icon: Users,
      title: 'Full-Stack Development',
      description: 'Complete frontend and backend solutions with cloud integration.'
    }
  ];
  ...
  return (
    <div className="space-y-0">
      ...
      <section className="relative min-h-screen overflow-hidden flex items-center">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-background/80 via-secondary/60 to-background/80"></div>
            ...
            <div className="space-y-8 animate-fade-in">
              <div className="space-y-6">
                ...
                <p className="text-xl lg:text-2xl text-muted-foreground leading-relaxed max-w-xl">
                  Nayriti Technologies empowers businesses with cutting-edge software solutions, 
                  ERP systems, and AI-driven IT consultancy services.
                </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" asChild className="group bg-gradient-to-r from-accent to-primary hover:shadow-lg hover:scale-105 transition-all duration-300">
                  <Link to="/services">
                    Explore Our Services
                    <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
                  </Link>
                </Button>
                <Button variant="outline" size="lg" asChild className="hover:bg-accent/10 hover:border-accent transition-all duration-300">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 pt-8">
                {stats.map((stat, index) => (
                  <div key={index} className="text-center group">
                    <div className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-accent to-primary bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">{stat.number}</div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center space-x-3 group">
                        ...
                        <div>
                          <span className="text-foreground font-medium">Established in 2025</span>
                          <p className="text-sm text-muted-foreground">Fresh perspective with modern solutions</p>
                        </div>
                      </div>
                      <div className="flex items-center space-x-3 group">
                        <div className="p-2 bg-accent/10 rounded-lg group-hover:bg-accent/20 transition-colors">
                        ...
                        <div>
                          <span className="text-foreground font-medium">Decade of Expertise</span>
                          <p className="text-sm text-muted-foreground">Combined team experience in IT</p>
                        </div>
                      </div>
                      <div className="flex items-center space-x-3 group">
                        <div className="p-2 bg-accent/10 rounded-lg group-hover:bg-accent/20 transition-colors">
                        ...
                        <div>
                          <span className="text-foreground font-medium">Full-Stack Solutions</span>
                          <p className="text-sm text-muted-foreground">End-to-end development services</p>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <section className="py-16 bg-card/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-2xl font-bold text-foreground mb-4">Technologies We Master</h2>
            <p className="text-muted-foreground">Cutting-edge tools and frameworks for modern solutions</p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="group hover:shadow-xl transition-all duration-500 border-border hover:border-accent/50 bg-card/80 backdrop-blur-sm hover:bg-card/90 transform hover:-translate-y-2">
                <CardContent className="p-6">
                  <div className="flex items-center space-x-4 mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-foreground group-hover:text-accent transition-colors">{feature.title}</h3>
                  </div>
              ...
              <div key={index} className="relative group">
                <div className="text-center space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="text-sm font-bold text-accent">{step.step}</div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="group hover:shadow-xl transition-all duration-300 border-border hover:border-accent/30 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                From traditional business models to cutting-edge digital solutions, we help companies 
                in Uttar Pradesh and beyond embrace the future of technology.
              </p>
              
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-accent rounded-full animate-pulse"></div>
                  <span className="text-foreground">AI-Powered Business Intelligence</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-accent rounded-full animate-pulse delay-100"></div>
                  <span className="text-foreground">Cloud-First Architecture</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-accent rounded-full animate-pulse delay-200"></div>
                  <span className="text-foreground">Scalable ERP Solutions</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-card/80 to-card/60 backdrop-blur-lg rounded-2xl p-8 border border-border/50 shadow-2xl">
                <div className="space-y-6">
                  <h3 className="text-xl font-bold text-foreground text-center">Transform Today</h3>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Let's discuss how Nayriti Technologies can help you achieve your digital transformation goals with our cutting-edge solutions.
              </p>
            </div>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button size="lg" asChild className="group bg-gradient-to-r from-accent to-primary hover:shadow-xl hover:scale-105 transition-all duration-300">
                <Link to="/contact">
